...
public class FlexibleGridLayout : LayoutGroup
{
   ...
   // public Vector2 MaxCellSize = new Vector2(180, 100);
    ...
    public override void CalculateLayoutInputHorizontal()
    {
        ...
        if (fitType == FitType.WIDTH || fitType == FitType.HEIGHT || fitType == FitType.UNIFORM)
        {
            ...
            columns = 4;// Mathf.CeilToInt(squareRoot);
        }
        ...
        //cellSize.x = cellSize.x > MaxCellSize.x ? MaxCellSize.x : cellSize.x;
        //cellSize.y = cellSize.y > MaxCellSize.y ? MaxCellSize.y : cellSize.y;
        int columnCount = 0;
        int rowCount = 0;
